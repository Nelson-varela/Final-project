...
import { ThumbsupIcon, TrashIcon } from '@primer/octicons-react'
            ...
            <div className="card-body">
              ...
              <div className="row">
                ...
                {(user?.result?._id === post?.creator) && (
                  <p className="col-1 position-absolute top-0 end-0 btn btn-outline-danger m-2"
                    onClick={() => dispatch(deletePost(post._id))}><TrashIcon className="pe-auto" size={16} /> </p>
                )}
                {/* { (user?.result?._id === post?.creator) && (
